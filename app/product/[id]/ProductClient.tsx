...
export default function ProductClient({ product }: { product: any }) {
  ...
  /*
   * Product ke paas 4 images hon to sab use hongi.
   * Agar purane product mein images field nahi hai,
   * to product.image ko fallback ke taur par use kiya jayega.
   */
  ...
  const currentImage =
    productImages[activeImage] || product.image || "";
